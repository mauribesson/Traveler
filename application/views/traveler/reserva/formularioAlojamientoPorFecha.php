...
<div class="container">
  <div class="row">
    <div class="col-md-6">      
      <h2>Ingrese las fechas para la búsqueda de Alojamientos</h2>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6" >
      <form action="<?php echo base_url('/index.php/traveler/listaPorFecha'); ?>" method="post" accept-charset="utf-8">
